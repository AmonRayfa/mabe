...
<div align="center">
  <a href="https://koseka.net/book/standard"><img src="https://img.shields.io/badge/Compliance-Koseka%20Standard-304CD3?style=flat&color=12398D" alt="Koseka Standard" /></a>
...
This project adheres to the [Koseka Standard](https://koseka.net/book/standard), which provides standardized versioning and contribution rules. So, make sure to read it first before contributing to the project in any way. Additionally, please refer to the [Contribution Guide](CONTRIBUTING.md) for setup instructions and guidance on how to contribute the project.
