...
1.  **GitHub Security Advisories:** Use the "Report a vulnerability" button located in the [**Security**](https://github.com/AmonRayfa/mabe/security) tab of the repository.
