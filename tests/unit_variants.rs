...
enum MyError {
    ...
    #[reason("The reason message for Error2. This is a {{{test}}}.")]
    Error2,
    ...
    #[solution("The solution message for Error5. This is a {{{test.")]
    #[error("The error message for Error5. This is a test}}}.")]
    Error5,

    #[error("The error message for Error6. This is a {{test}.")]
    #[reason("The reason message for Error6. This is a {test}}.")]
...
fn test() {
    ...
    assert_eq!(error2.reason(), "The reason message for Error2. This is a {test}.");
    ...
    assert_eq!(error5.reason(), "");
    assert_eq!(error5.solution(), "The solution message for Error5. This is a {{test.");
    ...
    assert_eq!(error6.reason(), "The reason message for Error6. This is a {test}.");
